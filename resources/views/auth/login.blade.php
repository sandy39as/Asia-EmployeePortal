<x-guest-layout>
    ...
    <div class="mb-6 text-center">
        ...
        <p class="mt-1.5 text-xs sm:text-sm text-slate-500 font-medium">
            Gunakan ID Login atau email Anda untuk melanjutkan
        </p>
    ...
    >
        ...
        <div>
            ...
            <label
                for="username"
                class="block text-xs sm:text-sm font-extrabold text-slate-700 mb-1.5"
            >
                ID Login / Email
            </label>
            ...
            <input
                ...
                placeholder="Contoh: A0403 atau nama@email.com"
            ...
            <x-input-error
                ...
                class="mt-1.5 text-xs sm:text-sm font-bold text-rose-600"
            />
